...
export default function App() {
  ...
  // Responsive shell: full-screen on mobile, phone-frame mockup on md+ screens.
  const Shell: React.FC<{ children: React.ReactNode; centered?: boolean }> = ({ children, centered }) => (
